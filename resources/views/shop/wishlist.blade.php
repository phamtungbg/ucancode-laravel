...
<html lang="en">
  <head>
    <title>UcanCode - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <body class="goto-here">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">UcanCode@gmail.com</span>
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">UcanCode</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="shop.html">Sản phẩm</a>
              	<a class="dropdown-item" href="wishlist.html">Sản phẩm bạn yêu thích</a>
                <a class="dropdown-item" href="product-single.html">Chi tiết sản phẩm</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Trang chủ</a></span> <span>Danh sách yêu thích</span></p>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">UcanCode</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Của hàng</a></li>
...
Hình thức thanh toán</a></li>
	                <li><a href="#" class="py-2 d-block">Thông tin được bảo mật</a></li>
	              </ul>
	              <ul class="list-unstyled">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Dũng tiến, thường tín, hà nội</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">035 665 3300</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">ucancode@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://ucancode.edu.vn" target="_blank">UcanCode</a>
